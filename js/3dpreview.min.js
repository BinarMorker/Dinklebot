...
Data.CanvasList[b]=$("#canvas-"+b).get()[0];Data.SpasmList[b]=new Spasm.ItemPreview(Data.CanvasList[b],Url+"/util/ApiProxy.php?s=www.bungie.net&p=");$("#button-"+b).on("click",function(c){c.preventDefault();
...
}var a=[];b.forEach(function(e){if(Data.GearAssets[e]==null){a.push(e);}});if(a.length>0){var c=a.map(function(e){return Url+"/util/ApiProxy.php?s=www.bungie.net&p=/platform/destiny/manifest/gearAsset/"+e+"/";
...
}});if(a.length>0){var c=new XMLHttpRequest();c.open("GET",Url+"/util/ApiProxy.php?s=www.bungie.net&p=/Platform/Destiny/Manifest/InventoryItem/&x="+a.join(","),true);
...
});d(true);};c.send();}else{d(true);}}function getShaderDetails(a,c){var b=new XMLHttpRequest();b.open("GET",Url+"/util/ApiProxy.php?s=www.bungie.net&p=/Platform/Destiny/Manifest/InventoryItem/"+a,true);
...
b.open("GET",Url+"/util/ApiProxy.php?s=www.bungie.net&p=/Platform/Destiny/"+a+"/Account/"+d,true);b.onload=function(){try{var e=JSON.parse(b.responseText);
